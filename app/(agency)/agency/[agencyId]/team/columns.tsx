...
import { UsersWithAgencySubAccountPermissionsSidebarOptions } from '@/lib/agency/types'
import { useModal } from '@/components/agency/modal-provider'
import CustomModal from '@/components/agency/custom-modal'
import UserDetails from '@/components/agency/user-details'
import { deleteUser, getUser } from '@/lib/agency/queries'
...
export const columns: ColumnDef<UsersWithAgencySubAccountPermissionsSidebarOptions>[] =
  [
    ...
    },
    {
      ...
      header: 'Role',
      cell: ({ row }) => {
        const role: AgencyRole = row.getValue('role')
        return (
          <Badge
            className={clsx({
