...
import { upsertFunnelPage } from '@/lib/agency/queries'
import { useModal } from '@/components/agency/modal-provider'
import CustomModal from '@/components/agency/custom-modal'
import { FunnelsForSubAccount } from '@/lib/agency/types'
import CreateFunnelPage from '@/components/agency/forms/funnel-page'
...
const FunnelSteps = ({ funnel, funnelId, pages, subaccountId }: Props) => {
  ...
  return (
    <AlertDialog>
      <div className="flex border-[1px] lg:!flex-row flex-col h-full ">
  ...
  >
    ...
    <LucideEdit
      size={15}
      className="absolute top-1/2 left-1/2 opacity-100 transofrm -translate-x-1/2 -translate-y-1/2 group-hover:opacity-100 transition-all duration-100"
    />
  </Link>
