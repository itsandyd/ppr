...
<Tabs defaultValue="ad-campaigns">
  ...
  <TabsContent value="download-gates"><div className="flex flex-col items-center justify-center">
    <MdSnooze />
    <p className="text-center">
  ...
  <TabsContent value="loud-links"><div className="flex flex-col items-center justify-center">
    <MdSnooze />
    <p className="text-center">
