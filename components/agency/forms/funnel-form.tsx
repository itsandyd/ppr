...
import { saveActivityLogsNotification, upsertFunnel } from '@/lib/agency/queries'
import { useModal } from '../modal-provider'
import { CreateFunnelFormSchema } from '@/lib/agency/types'
...
const FunnelForm: React.FC<CreateFunnelProps> = ({
  ...
  const onSubmit = async (values: z.infer<typeof CreateFunnelFormSchema>) => {
    ...
    if (response)
      ...
      toast.error('Could not save funnel details')
    setClose()
    router.refresh()
  }
  return (
