...
import { FunnelPageSchema } from '@/lib/agency/types'
import { deleteFunnelePage, getFunnels, saveActivityLogsNotification, upsertFunnel, upsertFunnelPage } from '@/lib/agency/queries'
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                type="submit"
              >
                {form.formState.isSubmitting ? <Loader2 className="h-4 w-4 animate-spin" /> : 'Save Page'}
              </Button>
              ...
              {defaultData?.id && (
                ...
                >
                  {form.formState.isSubmitting ? <Loader2 className="h-4 w-4 animate-spin" /> : <Trash />}
                </Button>
              )}
              {defaultData?.id && (
                <Button
                ...
                >
                  {form.formState.isSubmitting ? <Loader2 className="h-4 w-4 animate-spin" /> : <CopyPlusIcon />}
                </Button>
              )}
            </div>
          </form>
