...
import { LaneFormSchema } from '@/lib/agency/types'
import { getPipelineDetails, saveActivityLogsNotification, upsertLane } from '@/lib/agency/queries'
...
const LaneForm: React.FC<CreateLaneFormProps> = ({
  ...
  const onSubmit = async (values: z.infer<typeof LaneFormSchema>) => {
    ...
    try {
      ...
      toast.error('Could not save lane')
    }
    setClose()
  }
  return (
