...
import { TicketFormSchema, TicketWithTags } from '@/lib/agency/types'
import { useModal } from '../modal-provider'
import { getSubAccountTeamMembers, saveActivityLogsNotification, searchContacts, upsertTicket } from '@/lib/agency/queries'
...
const TicketForm = ({ getNewTicket, laneId, subaccountId }: Props) => {
  ...
  }, [defaultData, setContactList, subaccountId, form])
