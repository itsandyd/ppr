...
import { v4 } from 'uuid'
import { AuthUserWithAgencySigebarOptionsSubAccounts, UserWithPermissionsAndSubAccounts } from '@/lib/agency/types'
import { useModal } from './modal-provider'
import { changeUserPermissions, getAuthUserDetails, getUserPermissions, saveActivityLogsNotification, updateUser } from '@/lib/agency/queries'
...
const UserDetails = ({ id, type, subAccounts, userData }: Props) => {
  ...
  //     agencyRole: userData ? userData.role : data?.user?.role || 'SUBACCOUNT_USER'
  //   },
  // })
        ...
        {/* <Form {...form}>
          ...
          >
            ...
            <Button
              ...
              type="submit"
            >
              {form.formState.isSubmitting ? <FaSpinner /> : 'Save User Details'}
            </Button>
