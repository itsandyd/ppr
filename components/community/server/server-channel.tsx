...
import { Edit, Hash, Lock, Mic, Settings, Trash, Video } from "lucide-react";
    ...
    return ( 
        ...
        >
            ...
            {channel.name === "general" && (
                <Lock 
                    className="ml-auto w-4 h-4 text-zinc-500 hover:text-zinc-600 dark:text-zinc-400 dark:hover:text-zinc-300"
                />
            )}
        </button>
     );
